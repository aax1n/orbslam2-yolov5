...
cv::Mat Tracking::GrabImageStereo(const cv::Mat &imRectLeft, const cv::Mat &imRectRight, const double &timestamp)
{
    ...
    mpORBextractorLeft->mvDynamicArea = mpDetector->mvDynamicArea;
    {
        ...
        mpViewer->_mmDetectMap = mpDetector->_mmDetectMap;
    }


    //！ ***********************************************

   /// 要运行的数据集已经为灰度图 不需要加这行代码 否则报错
   ...
   if(mImGray.channels()==3)
    ...
    mCurrentFrame.mvDetectArea = mpDetector->mvDetectArea;
    mCurrentFrame.cp_mmDetectMap = mpDetector->cp_mmDetectMap;

    mpDetector->mvDynamicArea.clear();
    mpDetector->mmDetectMap.clear();
    mpDetector->cp_mmDetectMap.clear();
    ///******************************YOLO******************
...
/// YOLO *************************************************************
   ...
   /// ****************YOLO *****************
    ...
    ///  线程上锁
     {
        std::unique_lock<std::mutex> lock(mpPointCloudMapping->mMutexPBFinsh);
        mpPointCloudMapping->cp_mmDetectMap =mpDetector->cp_mmDetectMap;
     }
...
/// *****************************YOLO*********************
    ...
    mpDetector->cp_mmDetectMap.clear();
    /// 11.10
    mpDetector->_mmDetectMap.clear();
    mpDetector->mvDynamicArea.clear();
    mpDetector->mvDetectArea.clear();
...
void Tracking::CreateNewKeyFrame()
{
    ...
    pKF->mvDetectArea = mCurrentFrame.mvDetectArea;
    //pKF->cp_mmDetectMap = mCurrentFrame.cp_mmDetectMap;
